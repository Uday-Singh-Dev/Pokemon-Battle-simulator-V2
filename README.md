...
The focus was on implementing a faithful type effectiveness chart, building a stat-driven damage system that accounts for attack, defence, special attack, and special defence, and creating a UI that feels polished and responsive using only Tkinter's canvas and widget system.
...
Animated XP bar with level up detection and stat scaling on level up
